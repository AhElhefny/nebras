<x-dashboard.layouts.master title="{{__('dashboard.team')}}">
<!-- BEGIN: Content-->
       ...
       <div class="header-navbar-shadow"></div>
         <div class="content-wrapper">
           <div class="content-header row">
             ...
             <x-dashboard.layouts.breadcrumb now="{{__('dashboard.team')}}">
            </x-dashboard.layouts.breadcrumb>
           <div class="col-12 mt-3">
                 <div class="card">
                    <div class="card-header">
                          <h4 class="card-title">{{__('dashboard.team')}}</h4>
                   </div>
                         ...
                         <div class="card-body">
                                <div class="table-responsive overflow-auto">
                                     <table class="table table-striped " id="teams-table">
                                          <thead>
                                               <a href="{{route('admin.teams.create')}}"><button  class="mb-2 btn btn-primary"><i class="mr-1 feather icon-plus"></i>{{__('dashboard.add team')}}</button></a>
                                                 <tr>
                                                      <th>{{__('dashboard.table name')}}</th>
                                                      <th>{{__('dashboard.table job')}}</th>
