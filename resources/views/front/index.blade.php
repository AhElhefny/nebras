...
<x-frontend.layouts.master>
            ...
            <div class="swiper-wrapper">
                @for ($i = 1; $i <= 3; $i++)
                    <div class="swiper-slide item">
                        <div class="banner__area-two"
                            data-background="{{ GeneralSetting::getValueForKey('slider' . $i) ? asset('frontAssets/images/header/' . GeneralSetting::getValueForKey('slider' . $i)) : asset('frontAssets/images/header/01_header.jpg') }}"
                            style="background-image: url('{{ asset('frontAssets/images/header/01_header.jpg') }}')">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="banner__area-two-content">
                                            ...
                                            <h1>{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('website_name_ar') : GeneralSetting::getValueForKey('website_name_en') }}
                                            </h1>
                                            <a class="theme-btn-1" href="#about">{{ __('dashboard.start') }} <i
            ...
            <div class="row gx-0">
                <div class="col-xl-4 col-lg-4">
                    <div class="features__area-two-item">
                        <div>
                            <h4>{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('feature_section1_title_ar') : GeneralSetting::getValueForKey('feature_section1_title_en') }}
                            </h4>
                            <p>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="features__area-two-item features__area-two-item-hover">
                        <div>
                            <h4>{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('feature_section2_title_ar') : GeneralSetting::getValueForKey('feature_section2_title_en') }}
                            </h4>
                            <p>
                            ...
                            <a class="simple-btn"
                                href="{{ route('front.group') }}">{{ __('dashboard.Discover More') }}<i
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="features__area-two-item">
                        <div>
                            <h4>{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('feature_section3_title_ar') : GeneralSetting::getValueForKey('feature_section3_title_en') }}
                            </h4>
                            <p>
            ...
            <div class="row mb-60">
                <div class="col-xl-6 col-lg-8">
                    <div class="about__page-title">
                        <span
                            class="subtitle">{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('nav2_ar') : GeneralSetting::getValueForKey('nav2_en') }}</span>
                        <h2>{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('about_title_ar') : GeneralSetting::getValueForKey('about_title_en') }}
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-12">
                    <div class="about__page-area">
                        <div class="about__page-area-experience">
                            <h3><span class="counter">{{ GeneralSetting::getValueForKey('about_exp_year') }}</span>+
                            </h3>
                            <p>{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('about_exp_desc_ar') : GeneralSetting::getValueForKey('about_exp_desc') }}
                            </p>
                        </div>
                        <img src="{{ asset('frontAssets/images/about/' . GeneralSetting::getValueForKey('about_image')) }}"
                            alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-60">
                <div class="col-xl-12">
                    <div class="services__area-title lg-t-center">
                        <span
                            class="subtitle one">{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('nav3_ar') : GeneralSetting::getValueForKey('nav3_en') }}</span>
                        <h2>{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('services_title_ar') : GeneralSetting::getValueForKey('services_title_en') }}
                        </h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-60">
                <div class="col-xl-12">
                    <div class="team__area-title lg-t-center">
                        <span
                            class="subtitle">{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('nav4_ar') : GeneralSetting::getValueForKey('nav4_en') }}</span>
                        <h2>{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('team_title_ar') : GeneralSetting::getValueForKey('team_title_en') }}
                        </h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="team__area-item-image">
                                ...
                                <div class="team__area-item-image-social">
                                    <ul>
                                        ...
                                        <li><a href="{{ $team->website }}"><i class="fal fa-basketball-ball"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="swiper-wrapper">
                            @foreach ($groups as $group)
                                <div class="sponsors__area-brand swiper-slide">
                                    <img src="{{ $group->image ?? asset('frontAssets/images/sponsors/01_sponsor.png') }}"
                                        alt="" style="width:102px; height:36px;">
                                </div>
                            @endforeach
                        </div>
                    </div>
    ...
    <div class="reviews__area"
        data-background="{{ GeneralSetting::getValueForKey('preview_background3') ? asset('frontAssets/images/reviews/' . GeneralSetting::getValueForKey('preview_background3')) : asset('frontAssets/images/reviews/01_reviews.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-8">
                    <div class="reviews__area-left">
                        <div class="reviews__area-left-title">
                            <h2>{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('review_title_ar') : GeneralSetting::getValueForKey('review_title_en') }}
                            </h2>
                        </div>
        ...
        <div class="container">
            <div class="row mb-60">
                <div class="col-lg-12 col-xl-8">
                    <div class="services__area-title lg-t-center">
                        <span
                            class="subtitle one">{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('nav5_ar') : GeneralSetting::getValueForKey('nav5_en') }}</span>
                        <h2>
    ...
    <div class="video__area"
        data-background="{{ GeneralSetting::getValueForKey('video_background4') ? asset('frontAssets/images/video/' . GeneralSetting::getValueForKey('video_background4')) : asset('frontAssets/images/video/01_video.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="video__area-play-icon video-pulse"> <a class="video-popup"
                            href="{{ GeneralSetting::getValueForKey('video_link') ?? 'https://www.youtube.com/watch?v=0WC-tD-njcA' }}"><i
        ...
        <div class="container">
            <div class="row mb-60">
                <div class="col-xl-6 col-lg-8">
                    <div class="about__page-title">
                        <span
                            class="subtitle">{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('nav6_ar') : GeneralSetting::getValueForKey('nav6_en') }}</span>
                        <h2>{{ app()->getLocale() == 'ar' ? GeneralSetting::getValueForKey('media_title_ar') : GeneralSetting::getValueForKey('media_title_en') }}
                        </h2>
                    </div>
                </div>
            </div>
