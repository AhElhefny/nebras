...
use App\Http\Resources\NotificationsResourc;
...
class NotificationsController extends Controller
{
    ...
    public function index(){
        ...
        return $this->ApiResponse(true,__('api.data retrieved successfully'),200,NotificationsResourc::collection($notifications));
    }
}
